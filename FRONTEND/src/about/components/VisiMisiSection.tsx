...
import { IconTarget, IconRocket, IconHeartHandshake, IconLeaf, IconUsers } from "@tabler/icons-react";
        ...
        <>
            <section className="bg-gradient-to-r from-[#FFFDF6] to-[#F5F7F8] py-16 px-4 md:px-10">
                    ...
                    >
                        ...
                        <motion.div variants={itemVariants} className="text-black md:order-1"> {/* Ubah text-white ke text-black */}
                            ...
                            <p className="text-lg md:text-xl leading-relaxed text-gray-700"> {/* Ubah text-gray-300 ke text-gray-700 */}
                                Menjadi perusahaan distribusi material bangunan terdepan di Indonesia, dikenal karena kualitas produk, inovasi layanan, dan komitmen terhadap kepuasan pelanggan serta keberlanjutan.
                            </p>
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-blue-100/20 via-transparent to-transparent opacity-30"></div> {/* Ubah warna dan opacity */}
                </div>
            </section>
        </>
    );
